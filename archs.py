...
'FCNNhub','UNetBnout','UNetTrainBnout','FCNNhubTDE','UNetTDE','UNetTDEv2','UNetTDEv3','UNetTDEv4','UNetTDEv5',
...
class UNetTDEv5(nn.Module):
    ...
    def forward(self, input):
        ...
        if self.train:  #when no model checker
            ...
            c_norm = self.l2_norm(self.embed)
            cos_val, sin_val =self.get_cos_sin(x0_4,c_norm)
