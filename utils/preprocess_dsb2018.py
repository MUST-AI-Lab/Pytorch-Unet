...
def main():
    ...
    os.makedirs('../data/dsb2018_%d/images' % img_size, exist_ok=True)
    os.makedirs('../data/dsb2018_%d/masks/0' % img_size, exist_ok=True)
    ...
    for i in tqdm(range(len(paths))):
        ...
        cv2.imwrite(os.path.join('../data/dsb2018_%d/images' % img_size,
                    os.path.basename(path) + '.png'), img)
        cv2.imwrite(os.path.join('../data/dsb2018_%d/masks/0' % img_size,
